...
figma.ui.onmessage = msg => {
  ...
  if (msg.type === 'anctionCreate'){
    ...
    const projectTitle: TextNode = figma.createText();
    ...
    const stateValue: TextNode = figma.createText();
    ...
    const userName: TextNode = figma.createText();
    ...
    const currentTime: TextNode = figma.createText();
    ...
    const bgImg: TextNode = figma.createText();
    bgImg.characters = "🪐️";
    bgImg.fontSize = 800;
    bgImg.opacity = 0.05;
    bgImg.rotation = 90;
